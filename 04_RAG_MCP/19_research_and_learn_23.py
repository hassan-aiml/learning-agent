...
/* ── All buttons: silver background, dark navy text ── */
.stButton > button,
...
/* ── Remove (✕) button: turns red on hover so action is clear ── */
    ...
    with st.sidebar:
        ...
        '''<div style="display:flex;align-items:center;gap:12px;padding:8px 0 14px;">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80 80" width="52" height="52" style="flex-shrink:0;">
            ...
            <line x1="40" y1="32" x2="40" y2="14" stroke="#60a5fa" stroke-width="2" stroke-linecap="round"/>
            <line x1="40" y1="48" x2="40" y2="66" stroke="#60a5fa" stroke-width="2" stroke-linecap="round"/>
            <line x1="32" y1="40" x2="14" y2="40" stroke="#60a5fa" stroke-width="2" stroke-linecap="round"/>
            <line x1="48" y1="40" x2="66" y2="40" stroke="#60a5fa" stroke-width="2" stroke-linecap="round"/>
            <line x1="34" y1="34" x2="20" y2="20" stroke="#93c5fd" stroke-width="1.5" stroke-linecap="round"/>
            <line x1="46" y1="34" x2="60" y2="20" stroke="#93c5fd" stroke-width="1.5" stroke-linecap="round"/>
            <line x1="34" y1="46" x2="20" y2="60" stroke="#93c5fd" stroke-width="1.5" stroke-linecap="round"/>
            <line x1="46" y1="46" x2="60" y2="60" stroke="#93c5fd" stroke-width="1.5" stroke-linecap="round"/>
            <circle cx="40" cy="13" r="4.5" fill="#1d4ed8" stroke="#60a5fa" stroke-width="1.5"/>
            <circle cx="40" cy="67" r="4.5" fill="#1d4ed8" stroke="#60a5fa" stroke-width="1.5"/>
            <circle cx="13" cy="40" r="4.5" fill="#1d4ed8" stroke="#60a5fa" stroke-width="1.5"/>
            <circle cx="67" cy="40" r="4.5" fill="#1d4ed8" stroke="#60a5fa" stroke-width="1.5"/>
            <circle cx="20" cy="20" r="3.5" fill="#0f172a" stroke="#93c5fd" stroke-width="1.5"/>
            <circle cx="60" cy="20" r="3.5" fill="#0f172a" stroke="#93c5fd" stroke-width="1.5"/>
            <circle cx="20" cy="60" r="3.5" fill="#0f172a" stroke="#93c5fd" stroke-width="1.5"/>
            <circle cx="60" cy="60" r="3.5" fill="#0f172a" stroke="#93c5fd" stroke-width="1.5"/>
          </svg>
          <div style="line-height:1.3;">
            <div style="font-size:1rem;font-weight:700;color:#e8f0fe;font-family:sans-serif;">Learn Smart</div>
            <div style="font-size:0.65rem;color:#60a5fa;letter-spacing:1.5px;font-family:sans-serif;">AI-POWERED</div>
          </div>
        </div>''',
