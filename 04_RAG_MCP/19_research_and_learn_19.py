...
:root {
    ...
    --green-dark:    #0d3a18;
    --green-light:   #e8f5ec;
    --green-glow:    rgba(26,107,46,0.12);
    --yellow:        #f5c800;
    --yellow-mid:    #d4ac00;
    --yellow-light:  #fffbe6;
    ...
    --border:        #c8e6cc;
    --text-primary:  #0d1f12;
    --text-secondary:#3a5e42;
    --text-hint:     #7aaa82;
}

/* ── Page background: soft mint cream ── */
html, body,
...
/* ── Content card: white with green border ── */
.block-container {
    background: var(--card-white) !important;
    padding: 1.5rem 2rem !important;
    box-shadow: 0 1px 4px rgba(26,107,46,0.1), 0 2px 8px rgba(26,107,46,0.06) !important;
}
...
section[data-testid="stSidebar"] > div > div {
    ...
    border-right: 1px solid var(--green-mid) !important;
}
section[data-testid="stSidebar"] * {
...
/* ── Primary buttons: green with yellow text ── */
...
[data-testid="stBaseButton-primary"] {
    ...
    box-shadow: 0 1px 3px rgba(26,107,46,0.3) !important;
}
...
[data-testid="stChatMessage"]:has([data-testid="stChatMessageAvatarUser"]) [data-testid="stChatMessageContent"] {
    ...
    border: 1px solid #e6d800 !important;
    border-left: 3px solid var(--yellow-mid) !important;
}
...
button[data-baseweb="tab"]:nth-of-type(1):hover { color: var(--green) !important; }
...
button[data-baseweb="tab"]:nth-of-type(2):hover { color: var(--yellow-mid) !important; }
button[data-baseweb="tab"]:nth-of-type(2)[aria-selected="true"] {
    background: transparent !important;
    border-bottom: 3px solid var(--yellow-mid) !important;
...
[data-testid="stAlert"][kind="warning"]  { border-left: 3px solid var(--yellow-mid) !important; }

/* ── Mobile ── */
@media (max-width: 640px) {
    .block-container { padding: 1rem 0.75rem !important; border-radius: 0 !important; border: none !important; }
    ...
    with st.sidebar:
        ...
        '''<div style="display:flex;align-items:center;gap:12px;padding:8px 0 14px;">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 140" width="44" height="31" style="flex-shrink:0;">
            <rect x="0" y="0" width="200" height="140" rx="28" fill="#1a6b2e"/>
            <rect x="6" y="6" width="188" height="128" rx="23" fill="none" stroke="white" stroke-width="0.5" opacity="0.2"/>
            <path d="M48 25 L48 115" stroke="#ffffff" stroke-width="12" stroke-linecap="round" fill="none"/>
            <path d="M48 25 Q98 25 98 52 Q98 75 48 75" stroke="#ffffff" stroke-width="12" stroke-linecap="round" fill="none"/>
            <path d="M72 75 L100 115" stroke="#ffffff" stroke-width="10" stroke-linecap="round" fill="none"/>
            <path d="M123 25 L123 115" stroke="#f5c800" stroke-width="12" stroke-linecap="round" fill="none" opacity="0.95"/>
            <path d="M123 115 L168 115" stroke="#f5c800" stroke-width="12" stroke-linecap="round" fill="none" opacity="0.95"/>
          </svg>
          <div style="line-height:1.3;">
            <div style="font-size:1rem;font-weight:700;color:#e8f5ec;font-family:sans-serif;">Research &amp; Learn</div>
            <div style="font-size:0.65rem;color:#f5c800;letter-spacing:1.5px;font-family:sans-serif;">POWERED BY AI</div>
          </div>
        </div>''',
