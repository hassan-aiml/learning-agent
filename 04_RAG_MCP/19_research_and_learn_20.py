...
button[data-baseweb="tab"]:nth-of-type(1):hover { color: var(--blue) !important; }
...
button[data-baseweb="tab"]:nth-of-type(2):hover { color: #0891b2 !important; }
...
with tab1:
    ...
    with st.sidebar:
        ...
        '''<div style="display:flex;align-items:center;gap:12px;padding:8px 0 14px;">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80 80" width="40" height="40" style="flex-shrink:0;">
            <rect width="80" height="80" rx="18" fill="#0f172a"/>
            <path d="M40 18 Q52 18 56 28 Q62 28 62 36 Q62 44 56 46 Q58 54 52 56 Q48 62 40 60 Q32 62 28 56 Q22 54 24 46 Q18 44 18 36 Q18 28 24 28 Q28 18 40 18 Z" fill="none" stroke="#60a5fa" stroke-width="2"/>
            <circle cx="40" cy="40" r="4" fill="#1d4ed8"/>
            <path d="M40 36 L40 26" stroke="#93c5fd" stroke-width="1.5" stroke-linecap="round"/>
            <path d="M36 40 L24 40" stroke="#93c5fd" stroke-width="1.5" stroke-linecap="round"/>
            <path d="M44 40 L56 40" stroke="#93c5fd" stroke-width="1.5" stroke-linecap="round"/>
            <path d="M37 37 L29 29" stroke="#93c5fd" stroke-width="1.5" stroke-linecap="round"/>
            <path d="M43 37 L51 29" stroke="#93c5fd" stroke-width="1.5" stroke-linecap="round"/>
            <path d="M37 43 L29 51" stroke="#93c5fd" stroke-width="1.5" stroke-linecap="round"/>
            <path d="M43 43 L51 51" stroke="#93c5fd" stroke-width="1.5" stroke-linecap="round"/>
            <circle cx="40" cy="24" r="3" fill="#60a5fa"/>
            <circle cx="24" cy="40" r="3" fill="#60a5fa"/>
            <circle cx="56" cy="40" r="3" fill="#60a5fa"/>
            <circle cx="29" cy="29" r="3" fill="#60a5fa"/>
            <circle cx="51" cy="29" r="3" fill="#60a5fa"/>
            <circle cx="29" cy="51" r="3" fill="#60a5fa"/>
            <circle cx="51" cy="51" r="3" fill="#60a5fa"/>
          </svg>
          <div style="line-height:1.3;">
            <div style="font-size:1rem;font-weight:700;color:#e8f0fe;font-family:sans-serif;">Learn Smart</div>
            <div style="font-size:0.65rem;color:#60a5fa;letter-spacing:1.5px;font-family:sans-serif;">POWERED BY AI</div>
          </div>
        </div>''',
